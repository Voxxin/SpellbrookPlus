 ...
 * {@link com.github.voxxin.spellbrookplus.unique.api.resource.ResourceManagerHelper#registerBuiltinResourcePack(net.minecraft.util.Identifier, net.fabricmc.loader.api.ModContainer, ResourcePackActivationType)}.
 ...
 * {@link com.github.voxxin.spellbrookplus.unique.api.resource.ResourceManagerHelper#registerReloadListener(IdentifiableResourceReloadListener)},
 * which are triggered when resources are reloaded.
 * A resource reload listener can depend on another and vanilla resource reload listener identifiers may be found in {@link com.github.voxxin.spellbrookplus.unique.api.resource.ResourceReloadListenerKeys}.</p>
 */

package com.github.voxxin.spellbrookplus.unique.api.resource;

import com.github.voxxin.spellbrookplus.unique.api.resource.IdentifiableResourceReloadListener;
import com.github.voxxin.spellbrookplus.unique.api.resource.ResourcePackActivationType;